...
for dp in range(54, 60): 
    for pTHat in pTHat_list[:-1]: 
        for i in range(40): 
            ...
            # print('cd /global/homes/t/td115/running_coupling/JETSCAPE-Tequila/build && ./FinalStateHadrons $SCRATCH/output/Tequila/running_coupling/PbPb2760/centrality30-40/Q02.2/%.6f_i%d.dat $SCRATCH/output/Tequila/running_coupling/PbPb2760/centrality30-40/Q02.2/hadrons/%.6f_i%d_chargedHadrons.txt' %(pTHat, i, pTHat, i))
