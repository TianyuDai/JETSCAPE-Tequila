...
for i, new_pT_hat_min in enumerate(pTHat_list[:-1]):
    for task in range(100): 
        with open('../config/Tequila_AuAu200.xml', 'rb') as xml_file: 
            ...
            file_name = '/global/cscratch1/sd/td115/output/Tequila/running_coupling/AuAu200/centrality40-50/MAP/%.6f_i%d' %(new_pT_hat_min, task)
            name.text = file_name
            ...
            is_path.text = '/global/cscratch1/sd/td115/AuAu200_hydro/centrality40-50/part-%d' %(task % 20)
            ...
            hydro_path.text = '/global/cscratch1/sd/td115/AuAu200_hydro/centrality40-50/part-%d' %(task % 20)
            ...
            alphas_hard_inel.text = str(0.31)
            alphas_hard_inel.set('updated', 'yes')
            
            tree.write('../config_files/Tequila_AuAu200_centrality40-50_MAP_%.6f_i%d.xml' %(new_pT_hat_min, task), xml_declaration=True, encoding='utf-8')
