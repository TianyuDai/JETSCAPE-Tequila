...
for i, new_pT_hat_min in enumerate(pTHat_list[:-1]): 
    for task in range(40): 
        with open('../config/Tequila_PbPb2760.xml', 'rb') as xml_file: 
            ...
            file_name = '/global/cscratch1/sd/td115/output/Tequila/running_coupling/PbPb2760/centrality0-5/dps/dp%d/%.6f_i%d' %(dp, new_pT_hat_min, task)
            name.text = file_name
            ...
            Q0 = matter.find('Q0')
            Q0.text = str(1.389989622*Q0_list[dp])
            Q0.set('updated', 'yes')
            ...
            tree.write('../dps/PbPb2760/centrality0-5/dp%d/Tequila_PbPb2760_%.6f_i%d.xml' %(dp, new_pT_hat_min, task), xml_declaration=True, encoding='utf-8')
