...
export BASEDIR=${HOME}
export PYTHIAINSTALLDIR=/global/common/software/m2730/td115/pythia8235
...
export EIGEN_INSTALL_DIR=/global/common/software/m2730/td115/eigen-eigen-3.3.7
export EIGEN3_ROOT=${EIGEN_INSTALL_DIR}
